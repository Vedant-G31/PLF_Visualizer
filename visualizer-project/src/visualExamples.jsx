...
const ARExamples = forwardRef((props, ref) => {
  ...
  return (
      <div className="flex justify-center items-center gap-4 pb-8 bg-linear-to-t from-[#093477] to-[#051E36] flex-col font-sans">
        ...
        <div className='flex flex-col flex-shrink  max-w-80 md:max-w-300 p-4 gap-5 justify-center'>
          ...
          <div className='flex flex-col md:flex-row items-center justify-center gap-4 bg-linear-to-t from-[#072C4F] to-[#0541A1] border-2 border-solid border-white text-white rounded-xl p-4'>
              <div className=' w-60 md:w-270'>
                <img src={bvsStandard} alt={"BVS Standard Aspect Ratio Still"}></img>
              </div>
              <div className='p-4'>
                <h1 className='text-center md:text-left text-[1.25rem] md:text-[2rem]'>2.40:1/2.39:1/1.85:1 (Standard Widescreen)</h1>
          ...
          <div className='flex flex-col md:flex-row items-center justify-center gap-4 bg-linear-to-t from-[#072C4F] to-[#0541A1] border-2 border-solid border-white text-white rounded-xl p-4'>
              <div className='w-60 md:w-360'>
                <img src={bvs143} alt={"BVS 1.43:1 Aspect Ratio Still"}></img>
              </div>
              <div>
                <h1 className='text-center md:text-left text-[1.25rem] md:text-[2rem]'>1.43:1 (IMAX 70mm)</h1>
              ...
              <div className='flex justify-center w-55 md:w-160'>
