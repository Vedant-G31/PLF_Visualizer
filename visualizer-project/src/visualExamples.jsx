...
const ARExamples = forwardRef((props, ref) => {
  ...
  return (
      <div className="flex justify-center items-center bg-linear-to-t from-[#093477] to-[#051E36] flex-col font-sans">
        ...
        <div className='flex flex-col flex-shrink max-w-300 p-4 gap-5 justify-center'>
          
          <div className='flex flex-row items-center justify-center gap-4 bg-linear-to-t from-[#072C4F] to-[#0541A1] border-2 border-solid border-white text-white rounded-xl p-4'>
              <div className='w-270'>
